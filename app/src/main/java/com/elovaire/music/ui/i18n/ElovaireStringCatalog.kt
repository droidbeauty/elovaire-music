...
internal fun privacySafetyCopy(
    ...
    fun copy(
        ...
        title = title,
        subtitle = listOf(localTitle, lyricsTitle).joinToString(" · "),
            ...
            add(
                PrivacySafetySectionCopy(
                    ...
                    "Artist pages may send an artist name or MusicBrainz identifier to MusicBrainz, " +
                        ...
                        "are cached on your device and removed when app data is cleared or the app is " +
                        "uninstalled.",
                ),
            )
            add(
                PrivacySafetySectionCopy(
                    ...
                    "Droid Beauty provides Elovaire without accounts, advertising, analytics, or data " +
                        ...
                        "The public privacy policy linked below provides the developer identity, privacy " +
                        "contact, retention details, and third-party provider information.",
